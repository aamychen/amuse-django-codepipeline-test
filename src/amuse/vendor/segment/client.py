...
from .utils import clean, guess_timezone
...
class Client(object):
    ...
    def __init__(
        ...
        self.debug = debug
        self.send = bool(write_key and send)
        if not write_key:
            self.log.warning('No Segment write key provided, will not send events')
    ...
    def _enqueue(self, msg):
        ...
        try:
            ...
            self.log.warn('analytics-python-amuse queue is full')
            return False, msg
